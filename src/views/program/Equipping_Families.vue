<template>
  <v-app>
    ...
    <div
      ...
      :key="index"
    >
      <h1 class="text-center white--text mx-auto small" style="width:60%">{{p.help}}</h1>
    ...
    >
      ...
      <p
        ...
        style="text-align: center;font-size: 60px;line-height: 1em;margin: 250px  250px 30px 250px;letter-spacing: -2px;padding:"
      >
        Sponsor a mother today and change a life like
...
export default {
  ...
  firestore() {
    ...
    // };
    let cityRef = db.collection("programs").doc("9UA2wQxwNuAfxkhQaGX3");
    let productRef = db.collection("story").doc("BSfUr6fhYZzdb1C8LFRU");
    let getDoc = cityRef
      .get()
      .then(doc => {
        if (!doc.exists) {
