  ...
  <v-app>
    ...
    >
      ...
      <p
        ...
        style="text-align: center;font-size:  70px;line-height: 1em;margin: 250px  200px 30px 250px;letter-spacing: -2px;padding:"
      >
...
export default {
  ...
  firestore() {
    ...
    // };
    let cityRef = db.collection("programs").doc("06mUrA8PR8pppc1nQnbM");
    let productRef = db.collection("story").doc("QqndnKgQssMhGmCnJxut");
    let getDoc = cityRef
      .get()
      .then(doc => {
        if (!doc.exists) {
