                ...
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="4" sm="4" md="4">
                      ...
                      <div
                        v-for="(point, index) in editedItem.firstCol_points"
                        :key="index"
                      >
                        <v-textarea
                          outlined
                    ...
                    <v-col cols="4" sm="4" md="4">
                      ...
                      <v-card class="mx-auto" max-width="344">
                        <v-img
                          :src="editedItem.secondCol_image"
                          height="200px"
                        ></v-img>
                      </v-card>
                    </v-col>
