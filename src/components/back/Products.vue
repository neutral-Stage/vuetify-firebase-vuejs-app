...
export default {
  ...
  methods: {
    ...
    uploadbackImage(e) {
      ...
      var storageRef = fb
        .storage()
        .ref("stories/" + Math.random() + "_" + backImage.title);
    ...
    uploadimage(e) {
      ...
      var storageRef = fb
        .storage()
        .ref("stories/" + Math.random() + "_" + image.title);
    ...
    uploadimage_1(e) {
      ...
      var storageRef = fb
        .storage()
        .ref("stories/" + Math.random() + "_" + image_1.title);
